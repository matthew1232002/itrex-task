...
<<<<<<< Updated upstream:src/components/doctor/patients/modals/ResolutionModal.styled.ts
...
>>>>>>> Stashed changes:src/components/doctor/patients/modals/CreateResolution.styled.ts
